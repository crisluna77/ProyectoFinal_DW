...
function handleEdit(usuario) {
    ...
    if (usuarioDiv) {
        ...
        editForm.innerHTML = `
            <input type="text" id="edit-username" value="${usuario.username}" readonly required>
            <input type="email" id="edit-email" value="${usuario.email}" readonly required>
            <input type="text" id="edit-role" value="${usuario.role}" readonly required>
            <input type="date" id="edit-date-of-birth" value="${usuario.date_of_birth}" required>
            <input type="text" id="edit-full-name" value="Nombre completo" required>
            <select id="edit-role">
